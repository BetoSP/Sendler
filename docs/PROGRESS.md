...
| 6 | Escaneo de Asistente con QR desde la PWA Familias (rediseñada 2026-07-22, ver `docs/claude_history.md` — ya no es una página pública sin login) | 🟡 En progreso — decisión de arquitectura tomada, empezando implementación (pendiente #73) |
